...
<input type="button" onclick="javascript:jsf__pay();" value="결제창 호출">
</div>
<form name="kcp_order_info" id="kcp_order_info" action="/authPay"
		method="post" accept-charset="euc-kr">
		<input type="hidden" name="ordr_idxx"
			value="${data.ordr_idxx }"> <input type="hidden"
			name="good_name" value="${data.good_name }"> <input
			type="hidden" name="good_mny" value="${data.good_mny }">
		<input type="hidden" name="buyr_name"
			value="${data.buyr_name }"> <input type="hidden"
			name="site_cd" value="${data.site_cd }">
