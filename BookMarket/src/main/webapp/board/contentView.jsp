...
<div class="container py-4">
	...
	<div class="row align-items-md-stretch   text-center">	 	
		<form action="./boardWritePro.do" name="newWrite" method="post">
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-3">
					...
					<input name="name" type="text" class="form-control" value="${article.name}" readonly="readonly">
				</div>
			</div>
			<div class="mb-3 row">
				<label class="col-sm-2 control-label" >제목</label>
				<div class="col-sm-5">
					<input name="subject" type="text" class="form-control" value="${article.subject}" readonly="readonly">
				</div>
			</div>
			<div class="mb-3 row">
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-8">
					<textarea name="content" cols="50" rows="5" class="form-control" readonly="readonly" style="resize: none;">${article.content}</textarea>
				</div>
			</div>
		...
		<div class="py-2" align="center">
			...
			<a href="#" onclick="checkSession('./boardUpdate.do?num=${article.num}&pageNum=${pageNum}')" 
			class="btn btn-outline-primary"> 글수정</a>
			<a href="#" onclick="checkSession('./boardDelete.do?num=${article.num}&pageNum=${pageNum}')"  
			class="btn btn-outline-danger"> 글삭제</a>
		</div>
	</div>
